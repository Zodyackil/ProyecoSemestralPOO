 ...
 * @author juan carlos
 */
public class MantenedorModificado extends javax.swing.JFrame {

    Conexion cc = new Conexion();
    Connection cn = cc.Conexion();
    
    public MantenedorModificado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/new usuario.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        /**
         Llamo a la clase personalBD y uso el motodo para modificar a los usuarios.
         */
        PersonalBD nueva = new PersonalBD();
        nueva.actualizacion();      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenedorModificado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenedorModificado().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtPrivilegio;
